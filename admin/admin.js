...
document
  ...
  .addEventListener("click", async function () {
    ...
    const framework = document.getElementById("templateFramework")?.value || "";
    const filesIncluded =
      document.getElementById("templateFilesIncluded")?.value || "";
    const support = document.getElementById("templateSupport")?.value || "";
    ...
    if (!name || !description || !category || !templateFile || !previewFile) {
    ...
    try {
      ...
      formData.append("filesIncluded", filesIncluded);
  ...
  try {
    ...
    templates.forEach((template) => {
      ...
      const freeBadge = template.isFree
        ? '<span class="badge badge-free ms-2">Free</span>'
        : "";
      ...
      container.innerHTML += `
                <div class="col-md-4 mb-4">
                    <div class="card template-card h-100">
                        <img src="${
                          template.previewUrl ||
                          "https://via.placeholder.com/800x600/f8f9fc/5e6278?text=Template+Preview"
                        }" 
                                class="card-img-top" 
                                alt="${template.name}" 
        ...
        template.status
                        ...
                        <div class="card-footer bg-transparent">
                            ...
                            <button class="btn btn-sm btn-outline-info ms-1 details-btn" data-id="${
                              template._id
                            }">
    ...
    coupons.forEach((coupon) => {
      ...
      tableBody.innerHTML += `
        ...
        coupon.status
                    ...
                    <td>
                        <button class="btn btn-sm btn-outline-primary edit-coupon-btn" data-id="${
                          coupon._id
                        }">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn btn-sm btn-outline-danger ms-1 delete-coupon-btn" data-id="${
                          coupon._id
                        }">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Template Details: ${
                      template.name
                    }</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <p>${
                                  template.livePreviewUrl || "Not provided"
                                }</p>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="mt-2 text-center">
                                    <img src="${
                                      template.previewUrl ||
                                      "https://via.placeholder.com/300x200/f8f9fc/5e6278?text=No+Preview"
                    ...
                    <form id="editTemplateForm">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <label class="toggle-switch">
                                            <input type="checkbox" id="editTemplateIsFree" ${
                                              template.isFree ? "checked" : ""
                                            }>
                                            <span class="toggle-slider"></span>
                                        </label>
                                        <span class="form-check-label" id="editPricingLabel">${
                                ...
                                <div class="mb-3">
                                    <label for="editTemplateDiscountedPrice" class="form-label">Discounted Price (Optional)</label>
                                    <input type="number" class="form-control" id="editTemplateDiscountedPrice" min="0" value="${
                                ...
                                <div class="mb-3">
                                    <label for="editTemplateLayout" class="form-label">Layout</label>
                                    <input type="text" class="form-control" id="editTemplateLayout" value="${
                                      template.layout || ""
                                    }" placeholder="e.g. Responsive, Fixed, Grid">
                                </div>
                                <div class="mb-3">
                                    <label for="editTemplateFramework" class="form-label">Framework</label>
                                    <input type="text" class="form-control" id="editTemplateFramework" value="${
                                      template.framework || ""
                                    }" placeholder="e.g. Bootstrap 5, Tailwind CSS, React">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="editTemplateFilesIncluded" class="form-label">Files Included</label>
                                    <input type="text" class="form-control" id="editTemplateFilesIncluded" value="${
                                      template.filesIncluded || ""
                                    }" placeholder="e.g. HTML, CSS, JS, Documentation">
                                </div>
                                <div class="mb-3">
                                    <label for="editTemplateSupport" class="form-label">Support</label>
                                    <input type="text" class="form-control" id="editTemplateSupport" value="${
                                      template.support || ""
                        ...
                        <div class="detail-section">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="editTemplateInstructions" rows="3" placeholder="Step-by-step instructions for using this template...">${
                                  template.instructions || ""
                                }</textarea>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <form id="editCouponForm">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="editCouponCode" value="${
                              coupon.code
                            }" required>
                        </div>
                        <div class="mb-3">
                            <label for="editCouponDiscount" class="form-label">Discount Value*</label>
                            <input type="number" class="form-control" id="editCouponDiscount" min="0" value="${
                              coupon.discount
                            }" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="editCouponMaxUsage" min="1" value="${
                              coupon.maxUsage
                            }" required>
                        </div>
                        <div class="mb-3">
                            <label for="editCouponValidUntil" class="form-label">Valid Until*</label>
                            <input type="date" class="form-control" id="editCouponValidUntil" value="${
...
async function updateTemplateCounts() {
  try {
    ...
    const totalRevenue = paidTemplates.reduce(
      (sum, template) => sum + (template.price || 0),
      0
    );
    document.getElementById(
      "totalRevenue"
